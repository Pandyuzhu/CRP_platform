...
import logging
from typing import Tuple  # 添加了这个导入语句
...
class RTKDevice:
    ...
    def _circular_motion(self):
        ...
        self.base_coords = (self.radius * math.cos(self.angle), self.radius * math.sin(self.angle), 0)
    ...
    def _create_packet(self):
        ...
        data = struct.pack('<Ifff', timestamp, self.base_coords[0], self.base_coords[1], self.base_coords[2])
        return data
